        ...
        if (line.length() > 0) {
            ...
            do {
                ...
                if (lastHeader != null && (firstChar == ' ' || firstChar == '\t')) {
                    ...
                    if (!HttpHeaders.eq(name, HttpHeaders.Names.CONTENT_LENGTH) &&
                        !HttpHeaders.eq(name, HttpHeaders.Names.TRANSFER_ENCODING) &&
                        !HttpHeaders.eq(name, HttpHeaders.Names.TRAILER)) {
